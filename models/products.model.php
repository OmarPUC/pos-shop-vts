...
class ProductsModel{
	...
	static public function mdlAddProduct2($table, $data){

		$stmt = Connection::connect2()->prepare("INSERT INTO $table(idCategory, code, description, image, stock, buyingPrice, sellingPrice) VALUES (:idCategory, :code, :description, :image, :stock, :buyingPrice, :sellingPrice)");
	...
	static public function mdlEditProduct1($table, $data){

		$stmt = Connection::connect2()->prepare("UPDATE $table SET idCategory = :idCategory, description = :description, image = :image, stock = :stock, buyingPrice = :buyingPrice, sellingPrice = :sellingPrice WHERE code = :code");
	...
	static public function mdlDeleteProduct1($table, $data){
	...
	static public function mdlUpdateProduct1($table, $item1, $value1, $value){
	...
	static public function mdlShowAddingOfTheSales1($table){

		$stmt = Connection::connect2()->prepare("SELECT SUM(sales) as total FROM $table");
