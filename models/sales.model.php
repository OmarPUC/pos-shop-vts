...
class ModelSales{
	...
	static public function mdlAddSale2($table, $data){

		// $stmt = Connection::connect()->prepare("SELECT customers.name FROM customers INNER JOIN $table WHERE customer.id = sales.idCustomer");

		$stmt = Connection::connect2()->prepare("INSERT INTO $table(code, idCustomer, idSeller, products, tax, netPrice, totalPrice, paymentMethod) VALUES (:code, :idCustomer, :idSeller, :products, :tax, :netPrice, :totalPrice, :paymentMethod)");
