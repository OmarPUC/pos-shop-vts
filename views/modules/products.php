            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <?php 
                          ...
                          // $product = controllerProducts::ctrShowProducts($item, $value, $order);

                          // if(!$product){

                          //   echo '<input type="text" class="form-control input-lg" name="newCode" id="newCode" value="101" readonly>';
                          // }
                          // else{
                          ...
                          //   echo '<input type="text" class="form-control input-lg" name="newCode" id="newCode" value="'.$code.'" readonly>';
