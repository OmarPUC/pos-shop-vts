          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="newCustomer" placeholder="Custoemr name" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <?php 
                          ...
                          $customer = ControllerCustomers::ctrShowCustomers($item, $value);

                          if(!$customer){

                            echo '<input type="number" min="0" class="form-control" name="newIdDocument" id="newIdDocument" value="123" readonly>';
                          }
                          else{
                            ...
                            $idDocument = $value["idDocument"] +1;

                            echo '<input type="number" min="0" class="form-control" name="newIdDocument" id="newIdDocument" value="'.$idDocument.'" readonly>';
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="newPhone" placeholder="phone" data-inputmask="'mask':'(999)9999-9999'" data-mask required>
              </div>
            </div>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="editIdDocument" name="editIdDocument" value="<?php echo $idDocument["idDocument"]; ?>" readonly>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editPhone" id="editPhone" data-inputmask="'mask':'(999)9999-9999'" data-mask required>
