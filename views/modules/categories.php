                  ...
                  echo '<tr>
                          ...
                          <td>
                            ...
                            <div class="btn-group">
                              ...
                              <button class="btn btn-warning btn-lg btnEditCategory" idCategory="'.$value["id"].'" data-toggle="modal" data-target="#editCategories"><i class="fa fa-pencil"></i></button>
                          ...
                          <td>
                            ...
                            <div class="btn-group">
                              ...
                              <button class="btn btn-danger btn-lg btnDeleteCategory" idCategory="'.$value["id"].'"><i class="fa fa-times"></i></button>
