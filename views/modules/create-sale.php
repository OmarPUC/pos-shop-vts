                            ...
                            <tr>
                              ...
                              <td style="width:40%">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="" id="" placeholder="00000"  readonly required>
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input class="form-control input-lg" type="text" name="newCustomer" placeholder="Customer name" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-key"></i></span>
                <!-- <input class="form-control input-lg" type="number" min="0" name="newIdDocument" placeholder="Customer ID" required> -->
